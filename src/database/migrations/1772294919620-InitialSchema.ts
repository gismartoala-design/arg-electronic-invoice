...
export class InitialSchema1772294919620 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_104e1da40e18dd1c9236a0de34" ON "invoice_event" ("invoiceId", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."invoice_status_enum" AS ENUM('DRAFT', 'PENDING_SIGNATURE', 'SIGNED', 'SENDING', 'AUTHORIZED', 'NOT_AUTHORIZED', 'ERROR', 'CANCELLED')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."invoice_srireceptionstatus_enum" AS ENUM('PENDING', 'RECEIVED', 'DEVUELTA', 'ERROR')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."invoice_sriauthorizationstatus_enum" AS ENUM('PENDING', 'EN_PROCESAMIENTO', 'AUTORIZADO', 'NO_AUTORIZADO', 'DEVUELTA')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."issuer_ambiente_enum" AS ENUM('PRUEBAS', 'PRODUCCION')`,
    );
    await queryRunner.query(
      `CREATE TABLE "issuer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ruc" character varying(13) NOT NULL, "razonSocial" character varying(300) NOT NULL, "nombreComercial" character varying(300), "direccionMatriz" character varying(500) NOT NULL, "ambiente" "public"."issuer_ambiente_enum" NOT NULL DEFAULT 'PRUEBAS', "establecimiento" character varying(3) NOT NULL, "puntoEmision" character varying(3) NOT NULL, "certP12Path" character varying(500), "certPasswordEncrypted" text, "obligadoContabilidad" boolean NOT NULL DEFAULT false, "email" character varying(100), "telefono" character varying(20), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ce4a0faf5b5a25ff03acef7fc72" UNIQUE ("ruc"), CONSTRAINT "PK_0650c5a53be3a0d22b580e27d25" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_detail_tax" ADD CONSTRAINT "FK_9974492e7acc7b809bc9ad60225" FOREIGN KEY ("detailId") REFERENCES "invoice_detail"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_detail" ADD CONSTRAINT "FK_d4843ef5fb0acb6a1ea470236c6" FOREIGN KEY ("invoiceId") REFERENCES "invoice"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_payment" ADD CONSTRAINT "FK_29141a2a8c2192636ca4826fa4d" FOREIGN KEY ("invoiceId") REFERENCES "invoice"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_artifact" ADD CONSTRAINT "FK_3d79a15ec820495acb8aa5d3e71" FOREIGN KEY ("invoiceId") REFERENCES "invoice"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_event" ADD CONSTRAINT "FK_55d3fe7a84cc94fe0cb79a97b4d" FOREIGN KEY ("invoiceId") REFERENCES "invoice"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice" ADD CONSTRAINT "FK_098e2b1653b00e9cfd9af43703e" FOREIGN KEY ("issuerId") REFERENCES "issuer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "invoice" DROP CONSTRAINT "FK_098e2b1653b00e9cfd9af43703e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_event" DROP CONSTRAINT "FK_55d3fe7a84cc94fe0cb79a97b4d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_artifact" DROP CONSTRAINT "FK_3d79a15ec820495acb8aa5d3e71"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_payment" DROP CONSTRAINT "FK_29141a2a8c2192636ca4826fa4d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_detail" DROP CONSTRAINT "FK_d4843ef5fb0acb6a1ea470236c6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_detail_tax" DROP CONSTRAINT "FK_9974492e7acc7b809bc9ad60225"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."invoice_sriauthorizationstatus_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."invoice_srireceptionstatus_enum"`,
    );
    await queryRunner.query(`DROP TYPE "public"."invoice_status_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_104e1da40e18dd1c9236a0de34"`,
    );
    await queryRunner.query(`DROP TABLE "invoice_event"`);
    await queryRunner.query(`DROP TYPE "public"."invoice_event_type_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3d710b380c11a39df12cce9d12"`,
    );
